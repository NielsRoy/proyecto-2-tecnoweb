    ...
    private function getMenuItemsByRole($role)
    {
        ...
        $menuByRole = [
            'administrador' => [
                ...
                // Inventario
                ['id' => 'marcas', 'title' => 'Gestión de Marcas', 'subtitle' => 'Administrar marcas de insumos', 'url' => route('restaurant.marcas.index'), 'keywords' => 'marcas gestion administrar inventario'],
                ['id' => 'marcas-create', 'title' => 'Crear Marca', 'subtitle' => 'Agregar nueva marca', 'url' => route('restaurant.marcas.create'), 'keywords' => 'crear nueva marca agregar'],
                ['id' => 'insumos', 'title' => 'Gestión de Insumos', 'subtitle' => 'Administrar insumos', 'url' => route('restaurant.insumos.index'), 'keywords' => 'insumos inventario stock gestion administrar'],
                ['id' => 'insumos-create', 'title' => 'Crear Insumo', 'subtitle' => 'Agregar nuevo insumo', 'url' => route('restaurant.insumos.create'), 'keywords' => 'crear nuevo insumo agregar'],
                ['id' => 'movimientos', 'title' => 'Movimientos de Inventario', 'subtitle' => 'Ver movimientos de stock', 'url' => route('restaurant.movimientos.index'), 'keywords' => 'movimientos inventario stock ingresos salidas ajustes'],
                ['id' => 'movimientos-create', 'title' => 'Registrar Movimiento', 'subtitle' => 'Nuevo movimiento de inventario', 'url' => route('restaurant.movimientos.create'), 'keywords' => 'crear nuevo movimiento registrar ingreso salida ajuste'],
                
                // Compras
                ['id' => 'proveedores', 'title' => 'Gestión de Proveedores', 'subtitle' => 'Administrar proveedores', 'url' => route('restaurant.proveedores.index'), 'keywords' => 'proveedores gestion administrar'],
                ['id' => 'proveedores-create', 'title' => 'Crear Proveedor', 'subtitle' => 'Agregar nuevo proveedor', 'url' => route('restaurant.proveedores.create'), 'keywords' => 'crear nuevo proveedor agregar'],
                ['id' => 'compras', 'title' => 'Gestión de Compras', 'subtitle' => 'Administrar compras', 'url' => route('restaurant.compras.index'), 'keywords' => 'compras gestion administrar'],
                ['id' => 'compras-create', 'title' => 'Registrar Compra', 'subtitle' => 'Nueva compra de insumos', 'url' => route('restaurant.compras.create'), 'keywords' => 'crear nueva compra registrar'],
